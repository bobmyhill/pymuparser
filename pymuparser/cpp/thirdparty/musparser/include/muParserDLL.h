...
typedef value_type* (*facfun_type)(const char*);
typedef bool (*identfun_type)(const char*, int&, value_type&);
...
MU_PARSER_API value_type mupEval(parser_handle a_hParser);
...
MU_PARSER_API void mupDefineConst(parser_handle a_hParser, const char *a_szName, value_type a_fVal);
MU_PARSER_API void mupDefineStrConst(parser_handle a_hParser, const char *a_szName, const char *a_sVal);
MU_PARSER_API void mupDefineVar(parser_handle a_hParser, const char *a_szName, value_type *a_fVar);
...
MU_PARSER_API void mupGetExprVar(parser_handle a_hParser, unsigned a_iVar, const char **a_pszName, value_type **a_pVar);
MU_PARSER_API void mupGetVar(parser_handle a_hParser, unsigned a_iVar, const char **a_pszName, value_type **a_pVar);
MU_PARSER_API void mupGetConst(parser_handle a_hParser, unsigned a_iVar, const char **a_pszName, value_type &a_pVar);
